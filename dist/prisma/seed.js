...
async function main() {
    ...
    await prisma.recipe.create({
        data: { menuItemId: jollof.id, inventoryItemId: rice.id, quantityNeeded: 0.25 }
    });
    await prisma.recipe.create({
        data: { menuItemId: jollof.id, inventoryItemId: chicken.id, quantityNeeded: 0.25 }
    });
    await prisma.recipe.create({
        data: { menuItemId: jollof.id, inventoryItemId: oil.id, quantityNeeded: 0.05 }
    });
