...
let OrdersController = class OrdersController {
    ...
    getQueue(req, page, limit, type) {
        return this.ordersService.getQueueItems(req.user.role, page ? parseInt(page) : 1, limit ? parseInt(limit) : 20, type);
    }
    findAll(req) {
...
__decorate([
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN, client_1.Role.MANAGER, client_1.Role.WAITER, client_1.Role.CASHIER),
    (0, common_1.Post)(),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], OrdersController.prototype, "getQueue", null);
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
...
], OrdersController.prototype, "getInventoryReport", null);
__decorate([
...
__decorate([
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN, client_1.Role.MANAGER, client_1.Role.KITCHEN_STAFF, client_1.Role.BAR_STAFF),
    (0, common_1.Put)('item/:itemId/status'),
    __param(0, (0, common_1.Request)()),
